...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `80.3µs` | `1.1ms` |
| [Day 2](./src/bin/02.rs) | `13.5ms` | `13.2ms` |
| [Day 3](./src/bin/03.rs) | `282.5µs` | `188.8µs` |
| [Day 4](./src/bin/04.rs) | `927.6µs` | `962.8µs` |
| [Day 5](./src/bin/05.rs) | `1.1ms` | `894.5ms` |
| [Day 6](./src/bin/06.rs) | `994.0ns` | `909.0ns` |
| [Day 7](./src/bin/07.rs) | `1.2ms` | `1.3ms` |
| [Day 8](./src/bin/08.rs) | `2.5ms` | `18.4ms` |
| [Day 9](./src/bin/09.rs) | `305.6µs` | `297.9µs` |
| [Day 10](./src/bin/10.rs) | `2.5ms` | `2.8ms` |
| [Day 11](./src/bin/11.rs) | `7.2ms` | `7.1ms` |
| [Day 12](./src/bin/12.rs) | `15.1ms` | `829.9ms` |
